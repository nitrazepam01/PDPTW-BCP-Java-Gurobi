...
public final class ForwardLabel {
    private final int lastVertexId;
    ...
    public ForwardLabel(
        ...
        this(lastVertexId, reducedCost, time, load, completedMask, openMask, new int[0], vertexIds);
    }
    ...
    public ForwardLabel(
            ...
            List<Integer> vertexIds) {
        this(lastVertexId, reducedCost, time, load, completedMask, openMask,
